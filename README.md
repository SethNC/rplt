...
Want to use your own imagery (e.g., drone mosaic)? Process your drone images with [webodm.net](https://webodm.net/) and choose the option to generate tiles. These can be added locally with 'file://local directory/{z},{x}/{y}.png' or from a weblocation 'http://address/. . .'. Tiles can also be generated by QGIS or from other means. 

Be sure you know the format of your tiles. This if in TMS form be sure the `{z}/{x}/{-y}.png` y is negative. 
